...
파일 **내용**은 노출되지 않습니다. Drive 파일의 소유자는 OAuth를 승인한 계정이고,
...
| Drive 호출 예산 | 분당 200회, 초과 시 429. 캐시로 처리되는 검색은 예산을 쓰지 않습니다. |
...
| `npm run test:parity` | **GAS ↔ Docker 구현 대조** (470개, 일반 루트 / 슬래시 든 루트 2세트) |
